...
import { type Reino, type SaveStatus, INPUT_CLS } from "@/features/myself/garlia/components/types";
import { usePersonajesDelReino } from "@/features/myself/garlia/components/hooks";
import { type Ciudad } from "@/features/myself/garlia/views/EditorCiudad";
import { SaveIndicator } from "@/features/myself/garlia/components/UIComponents";
import { MarkdownEditor, WikiEntity } from "@/components/forms/Markdown/MarkdownEditor";
import { useWikilink } from "../components/WikilinkContext";
import { LoreTab } from "@/features/myself/garlia/components/LoreTab";
...
function ImagePickerModal({ onSelect, onClose }: { onSelect: (url: string) => void; onClose: () => void }) {
  ...
  useEffect(() => {
    import("@/features/myself/garlia/editorCapitulos/snippets/forms/SimpleImagePicker").then(m => setComponent(() => m.default));
  }, []);
