...
export function GrafoEnsayos({
  ...
  return (
    <>
      {/* ── Botón trigger ── */}
      <button
        className="flex items-center gap-1.5 px-2 py-1 rounded-lg text-micro font-bold uppercase tracking-widest border transition-all border-primary/10 text-primary/40 hover:bg-primary/10 hover:border-primary/20 hover:text-primary/70"
          ...
          >
            ...
            <div className="shrink-0 flex items-center justify-between px-4 py-3 border-b border-primary/[0.06] bg-primary/[0.02]">
              <div className="flex items-center gap-2">
                ...
                <span className="text-micro font-black uppercase tracking-widest text-primary/70" style={{ fontFamily: "var(--font-mono)" }}>
                  red de ensayos
                </span>
                <span className="text-micro text-primary/40" style={{ fontFamily: "var(--font-serif)", fontStyle: "italic" }}>
