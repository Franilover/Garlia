...
export default function PerfilPublico() {
  ...
  return (
    <>
      ...
      {/* ═══════════════════════════════════════════
          HERO HEADER — mismo diseño que el editor
      ═══════════════════════════════════════════ */}
      <div className="w-full animate-in fade-in duration-500">
        ...
        <div className="px-6 md:px-10 flex items-end gap-5 md:gap-7"
          ...
          {/* Nombre + título + status — con paddingTop para no taparse con el banner */}
        ...
        {/* Info rápida bajo el hero: descripción + fav + mascota */}
      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 pb-20">
        ...
        {/* Separador total descubrimientos */}
