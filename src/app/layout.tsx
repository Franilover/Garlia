      ...
      <body className={`${montserrat.className} antialiased bg-[#F0F0F0] min-h-screen flex flex-col`}>
        ...
        <AuthProvider>
          <DataProvider>
            <LightboxProvider>
              {/* 
                flex-grow sin pb-28: el padding inferior ahora lo maneja
                AppLogic > <main className="pb-16 md:pb-0"> para no duplicarlo
              */}
              ...
              <footer className="w-full pt-6 pb-20 md:pb-6 mt-auto text-center border-t border-gray-300 bg-white/50 backdrop-blur-sm">                <p className="text-gray-600 text-[10px] sm:text-xs px-4">
