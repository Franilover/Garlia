...
const TEXTOS: Record<Paso, { titulo: string }> = {
  sueltos: { titulo: "Varios Iums, todavía sin acomodar." },
  topologia: { titulo: "Se elige una topología: cadena, ramificación, ciclo…" },
  confirmando: { titulo: "Cada Ium confirma su rol dentro de ella." },
  estable: { titulo: "La configuración se estabiliza." },
  ori: { titulo: "Nace un Ori, una fuerza cósmica funcional." },
};
