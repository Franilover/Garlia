...
function DiagramaAcople({ replayKey, onReplay }: { replayKey: number; onReplay: () => void }) {
  ...
  const TEXTOS = [
    "3 Partículas sueltas, listas para acoplarse por función.",
    "Se acoplan en línea, cada una en su orden.",
    "El acople cierra: las 3 quedan enlazadas.",
    "Nace un Ium, una unidad funcional propia.",
  ];
