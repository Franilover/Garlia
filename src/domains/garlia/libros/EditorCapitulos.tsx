...
} from "@/domains/garlia/libros";
import {
  useCapituloEditor,
  useChapterGraph,
  usePosicionesNodos,
  useCapituloVersiones,
} from "@/domains/garlia/libros/capitulos/useCapitulosEditor";
import {
...
import {
  ...
  type StoryGraph,
} from "@/domains/garlia/libros/capitulos/storyGraph";
    ...
    <div className="flex-1 flex min-h-0 overflow-hidden">
      ...
      {palette && (
        <SnippetCommandPalette
          ...
          personajesFijadosIds={personajesIds}
          criaturasFijadasIds={criaturasIds}
          itemsFijadosIds={itemsIds}
          onClose={() => {
            setPalette(null);
            pendingReplaceRef.current = null;
            pendingSnippetRawRef.current = null;
...
export function EditorCapitulosPanel() {
  ...
  // (ver LibroDocumentoSection.tsx), pantalla completa, sin sidebar de
  // libros ni nada del editor de capítulos alrededor — solo el RichEditor.
