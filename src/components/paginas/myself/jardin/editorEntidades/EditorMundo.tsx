  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 overflow-y-auto p-6 gap-4">
      ...
      <div className="flex justify-end">
        <button
          onClick={() => onSave(activeSection)}
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest bg-primary text-btn-text hover:bg-primary/90 transition-all shadow-md shadow-primary/20"
        >
