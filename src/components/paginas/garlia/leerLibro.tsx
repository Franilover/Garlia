  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      type CapRaw = {
        ...
        fecha_publicacion: string; personajes_ids: string[]; reinos_ids: string[] | null; ciudades_ids: string[] | null; lugares_ids: string[] | null;
      ...
      if (esUUID(capIdParam)) {
        ...
        const { data: contenidos, error: capsError } = await supabase
          .from("capitulos")
          .select(`id, orden, titulo_capitulo, contenido, fecha_publicacion, personajes_ids, reinos_ids, ciudades_ids, lugares_ids,
