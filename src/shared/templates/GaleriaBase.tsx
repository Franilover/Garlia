              ...
              {mostrarBusqueda && (
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-bg-main border-primary/10 py-4 pl-12 pr-12 text-sm font-black text-primary uppercase outline-none focus:border-primary/30 transition-all placeholder:text-primary/20 placeholder:normal-case placeholder:font-normal" style={{ borderRadius: "var(--radius-card)", borderWidth: "var(--border-width)", borderStyle: "solid" }}
                  />
                  <AnimatePresence>
                    {busqueda && (
                      <motion.button
